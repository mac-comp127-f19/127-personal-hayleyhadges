//package comp127.graphicsPractice;
//
...
//
//        // TODO: create eyes
//        Ellipse eye = createEye(size*.5);
//        group.add(createEye(size));
...
//    }
//
//    private static Ellipse createEye(double size, double height, double width) {
//        double height1 = head.getHeight();
//        double width1 = head.getWidth();
//        Ellipse eye = new Ellipse(width1,height1,size*.1,size*.1);
