...
public class ListFormatting {
    ...
    public static List<String> numberEachItem(List<String> items) {
        int num =  1;
        List<String> numberItem = new ArrayList<>(items);
        for (String word : numberItem) {
            word = num + ". " + word;
            numberItem.set(num-1, word);
            System.out.println(numberItem.size());
            num += 1;
        }
