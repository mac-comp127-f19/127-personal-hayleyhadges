...
public class InkBlot {
    ...
    public void generateInkBlot() {
        RandomWalk xavier = new RandomWalk(150,0,300);
        RandomWalk yolanda = new RandomWalk(150,0,300);
        RandomWalk red = new RandomWalk(150,0,256);
        RandomWalk green = new RandomWalk(150,0,256);
        RandomWalk blue = new RandomWalk(150,0,256);
        for (int i = 0; i<15000; i++){
            Line x = advance(xavier,yolanda);
            Color y = getColor(red,green,blue);
            x.setStrokeColor(y);
            canvas.add(x);
            canvas.add(mirror(x));
        }
